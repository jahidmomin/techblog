...
<body>
		...
		<div class="container-fluid ">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link" href="#"
						data-bs-toggle="modal" data-bs-target="#posts" tabindex="-1"><i
							class="fas fa-plus"></i> Do Post</a></li>
	...
	<!-- Add Posts Modal -->
	<!-- Modal -->
	<div class="modal fade" id="posts" tabindex="-1"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="AddPostServlet" id="postform" method="post"
						enctype="multipart/form-data">
						...
						<div class="form-group mb-1">
							<input type="text" name="title" class="form-control" id="post"
								aria-describedby="title" placeholder="Enter Post Title">
						</div>
						<div class="form-group mb-1">
						...
						<div class="form-group mb-1">
							<textarea class="form-control" name="code" style="height: 200px"
								placeholder="Enter Program Code/Snippets If Contain.."></textarea>
						</div>
						<div class="form-group mb-1">
							<label class="form-label">Select Post Picture :</label> <input
								type="file" name="pic" class="form-control">
						</div>
						<div class="form-group text-center" id="loader"
							style="display: none">
...
<!-- loading posts ajax call -->
<script>
function getPosts(catId,a){
	$("#loaderpost").show();
	$.ajax({
		url : "load_post.jsp",
		data:{cid:catId},
